...
export const nav: DefaultTheme.Config['nav'] = [
  { text: 'Spring OAuth2 Authorization Server', link: '/authorization-server/01-基础集成/01-what-is-Spring-OAuth2-Authorization-Server' },
  // { text: '什么是Spring OAuth2 Authorization Server', link: '/authorization-server/what-is-Spring-OAuth2-Authorization-Server' },
  // {
  //   text: '我的分类',
  //   items: [
