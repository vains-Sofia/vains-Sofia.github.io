...
sequenceDiagram
    ...
    participant s as AuthorizationServer
...
![二维码登录演示.gif](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6bdc5eae94f64963aaea226bf228fe99~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1905&h=981&s=1553707&e=gif&f=289&b=fcfcfc)

# 附录
代码仓库：[Gitee](https://gitee.com/vains-Sofia/authorization-example)、[Github](https://github.com/vains-Sofia/authorization-example)
## 参考资料

[SpringBoot二维码登录(中)](https://www.cnblogs.com/GoodHelper/p/8643071.html)<br>
[反向工程解析QQ扫码登录的OAuth2流程](https://blog.51cto.com/solarboy/2154188)<br>
